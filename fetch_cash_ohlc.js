...
const ALL_SYMS = [
  ...
  'AEGISVOPAK','ANANTRAJ','BEML','BORORENEW','CONCORDBIO','CORDELIA',
  'DCBBANK','DELHIVERY','DLINKINDIA','EPL','EPACKPEB','FILATEX',
  'GALAPREC','GRAVITA','HDFCAMC','IDEAFORGE','INGERRAND','JKTYRE',
  'JUBLPHARMA','LLOYDSENGG','MACPOWER','MAXVOLT','MPSLTD','MUNJALAU',
  'NELCO','OBEROIRLTY','PENIND','PHOENIXLTD','PRESTIGE','PRICOLLTD',
